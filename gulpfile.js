// generated on 2023-10-19 using generator-webapp 4.0.0-8
...
// watch('app/styles/**/*.scss', parallel('styles'));
//  watch('app/scripts/**/*.js', parallel('scripts'));
 // watch('modernizr.json', parallel('modernizr'));
